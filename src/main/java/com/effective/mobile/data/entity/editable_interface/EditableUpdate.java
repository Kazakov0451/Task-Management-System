package com.effective.mobile.data.entity.editable_interface;
...
public interface EditableUpdate<ENTITY> {
     ...
     * Из текущей Сущности должны перезаписываться системные поля, id, createdAt, createdBy, deletedAt, deletedBy
     *
